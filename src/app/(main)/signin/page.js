...
export default function SigninPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary/10 via-white to-primary/10 flex items-center justify-center p-4">
        ...
        <div className="hidden lg:block">
          <div className="space-y-6">
            ...
            <p className="text-lg text-zinc-600">
              Continue your journey through the world of shared books and
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-600">Books Exchanged</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-primary">200+</p>
                  <p className="text-sm text-zinc-600">Exchange Points</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-primary">15K+</p>
                  <p className="text-sm text-zinc-600">Forum Posts</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert("Password reset functionality pending");
                  }}
                >
                  Forgot password?
                </a>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => alert("Facebook OAuth integration pending")}
                >
                  <svg
