              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    Browse and request books from readers in your area
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-zinc-900">Track Journey</h3>
                  <p className="text-zinc-600">
                    Add your story to each book's reading history
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    Connect with readers in book forums and communities
                  </p>
                </div>
              </div>
            </div>
