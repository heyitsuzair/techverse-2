    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <Text
            variant="h1"
            className="mb-2 flex items-center gap-2 sm:gap-3 text-xl sm:text-2xl lg:text-3xl"
          >
            ...
            <CardContent className="pt-4 sm:pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <Text
                    variant="caption"
                    className="text-zinc-600 mb-1 text-xs sm:text-sm"
                  >
                    Total Wishlist
                  </Text>
                  <Text
            ...
            <CardContent className="pt-4 sm:pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <Text
                    variant="h2"
                    className="text-green-600 text-2xl sm:text-3xl lg:text-4xl"
                  >
        ...
        {availableBooks.length > 0 && (
          <div className="mb-6 sm:mb-8">
            <div className="flex items-center gap-2 mb-3 sm:mb-4">
              ...
              <Text
                variant="h3"
                className="text-green-600 text-base sm:text-lg lg:text-xl"
              >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-1 sm:gap-0 mb-2">
                          <div className="min-w-0">
                            <Text
                              variant="h4"
                              className="mb-1 text-sm sm:text-base truncate"
                            >
                              {book.title}
                            </Text>
                            <Text
                              variant="body"
                              className="text-zinc-600 text-xs sm:text-sm truncate"
                            >
                              by {book.author}
                            </Text>
                          </div>
                        ...
                        <div className="space-y-1.5 sm:space-y-2 mb-2 sm:mb-3">
                          <div className="flex items-center gap-2">
                            ...
                            <Text
                              variant="body"
                              className="text-amber-600 font-semibold text-xs sm:text-sm"
                            >
                              {book.points} pts
                            </Text>
                          </div>
                    ...
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-2 sm:mb-3">
                          ...
                          <Text
                            variant="caption"
                            className="text-zinc-600 text-xs sm:text-sm"
                          >
